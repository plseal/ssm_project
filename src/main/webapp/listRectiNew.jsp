...
$(function(){
	$('#listTable').datagrid({
	    url:'${pageContext.request.contextPath}/rectiNew/listRectiGet.do?listRectiAc=' + document.all.myform.hid_listRectiAc.value 	
        ,rownumbers:true
        ,pagination:true
	    ...
	    ,columns:[[
			...
			{field:'checkdate',         title:'自查时间',width:0,align:'center'},
			{field:'location',          title:'自查地点',width:0,align:'center'},
			{field:'content',           title:'隐患内容',width:0,align:'center'},
	        ...
	        {field:'opt',               title:'操作',width:0,align:'center',  
	            formatter:function(value,rec){  
	                ...
	                + "color=blue href='${pageContext.request.contextPath}/rectiNew/"
	                														+"get_.do?taskid="+rec.taskid
	                														+"&taskname="+rec.taskstatus
	                														+"&javaid="+rec.javaid
	                														+"&fromPage=listRectiNew.jsp"
	        ...
	        {field:'delete_',               title:'删除操作',width:0,align:'center',  
	            formatter:function(value,rec){  
	                ...
	                var del = "  <a class='editcls' onclick='#'"  
			            + "color=blue href='${pageContext.request.contextPath}/rectiNew/"
			            														+"deleteListRectiNew.do?javaid="+rec.javaid
			            														+"&taskid="+rec.taskid
			...
			{field:'taskname',        title:'任务状态',width:0,align:'center',
				formatter:function(value,rec){
	            if (rec.taskname.indexOf("安全管理员验收结束流程") !=-1 || rec.taskname.indexOf("隐患发起人验收结束流程") != -1) {
...
//检索
function search_(){
	document.all.myform.action="${pageContext.request.contextPath}/rectiNew/toListRectiNew.do?listRectiAc="+document.all.myform.hid_listRectiAc.value;
	document.all.myform.submit(); 
}
function change_() {
  ...
  <td width = 33%>
   ...
   <td style="text-align:right;valign:bottom;font-size:30px;">
	...
	<div id="searchPanel" class="easyui-panel" style="padding:2px 5px;">
		...
		自查地点: <input name="s_location" value="${s_location}" class="rectimyinput" style="width:110px" maxlength=20>
		隐患类型: 
